        ...
        <div className={style.about__wrapper}>
          <div className={style.about__top}>
            ...
            <div className={style.about__top__right}>
              <img
                src={`${process.env.REACT_APP_STRAPI_URL}${about_image.url}`}
                alt="about"
              />
            </div>
          </div>
            ...
            <ul>
              <li className={style.about__main__item}>
                <div className={style.aboutListItemIcon}>
                  <img
                    src={`${process.env.REACT_APP_STRAPI_URL}${about_item_1_icon.url}`}
              ...
              <li className={style.about__main__item}>
                <div className={style.aboutListItemIcon}>
                  <img
                    src={`${process.env.REACT_APP_STRAPI_URL}${about_item_2_icon.url}`}
              ...
              <li className={style.about__main__item}>
                <div className={style.aboutListItemIcon}>
                  <img
                    src={`${process.env.REACT_APP_STRAPI_URL}${about_item_3_icon.url}`}
              ...
              <li className={style.about__main__item}>
                <div className={style.aboutListItemIcon}>
                  <img
                    src={`${process.env.REACT_APP_STRAPI_URL}${about_item_4_icon.url}`}
