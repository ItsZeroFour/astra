...
export interface ApiVypolnennyeRabotyVypolnennyeRaboty
  extends Struct.CollectionTypeSchema {
  collectionName: 'vypolnennye_raboties';
  info: {
    description: '';
    displayName: '\u0412\u044B\u043F\u043E\u043B\u043D\u0435\u043D\u043D\u044B\u0435 \u0440\u0430\u0431\u043E\u0442\u044B';
    pluralName: 'vypolnennye-raboties';
    singularName: 'vypolnennye-raboty';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::vypolnennye-raboty.vypolnennye-raboty'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    text_about: Schema.Attribute.Text;
